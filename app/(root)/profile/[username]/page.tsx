      ...
      <div className="max-w-5xl mx-auto mt-8 grid grid-cols-1 md:grid-cols-3 gap-6 px-6">
        ...
        <Card className="shadow-lg md:col-span-2">
          ...
          <CardContent className="px-6 py-4 grid grid-cols-3 gap-4 text-center">
            <div className="bg-gray-50 rounded-lg p-4 shadow hover:shadow-md transition">
              <p className="text-lg font-bold">{userData.itemsReported || 0}</p>
              <p className="text-gray-500">Reported</p>
            </div>
            <div className="bg-gray-50 rounded-lg p-4 shadow hover:shadow-md transition">
              <p className="text-lg font-bold">{userData.itemsFound || 0}</p>
              <p className="text-gray-500">Found</p>
            </div>
            <div className="bg-gray-50 rounded-lg p-4 shadow hover:shadow-md transition">
              <p className="text-lg font-bold">{userData.itemsClaimed || 0}</p>
